...
/** STOLEN, thanks dealerofallthecats and end-4
 * Provides extra features not in Quickshell.Services.Notifications:
 *  - Persistent storage
 *  - Popup notifications, with timeout
 *  - Notification groups by app
 TODO: i wish to rewrite tbh */
...
Singleton {
    ...
    property var filePath: Quickshell.env("HOME") + "/.cache/notifications.json" // TODO: add config option
    property list<Notif> list: []
    property var popupList: list.filter((notif) => notif.popup);
    property bool popupInhibited: Global.centerHubOpen || silent
